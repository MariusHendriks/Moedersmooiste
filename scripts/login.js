$(document).ready(function(){
    $("#backTo").on("click", function(){
        $("#loginBodyChild").css({position: "absolute", left: 0})
        var width = $("#loginBodyChild").width();
        $("#loginBodyChild").animate({left: width}, 500, "easeInOutCubic", function(){
            setTimeout(function(){
            ...
            setTimeout(function(){
                $.ajax({
                    ...
                    success: function(result){
                        if (result === "Login"){
                            $("#loginBodyChild").css({position: "absolute", right: 0})
                            var width = $("#loginBodyChild").width();
                            $("#loginBodyChild").animate({right: width}, 500, "easeInOutCubic", function(){
                                setTimeout(function(){
